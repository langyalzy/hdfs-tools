...
public class OperateHdfs {
    ...
    { 
        ...
        FileSystem fs = null;
		try {
			fs = FileSystem.get(URI.create(file), conf,"hdfs");
    ...
    { 
     ...
     public static void main(String[] args) throws IOException, URISyntaxException {
          String file = "hdfs://nameservice-jk/user/Administrator/test.txt";
         
          String localFile = "D:/test.txt";
         
          //String words = "This words is to write into file!\n";
          String words = "测试向HDFS里面写文件！asdfasld;kjfasd;fklj oasdjkgapoeuij f[oj [awopjeaw;rjol;";
